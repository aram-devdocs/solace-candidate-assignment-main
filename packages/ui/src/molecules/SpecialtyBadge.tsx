...
export const SpecialtyBadge: React.FC<SpecialtyBadgeProps> = ({
  ...
  const baseClasses = isActive
    ...
    : "inline-flex items-center gap-1 justify-center px-2 py-0.5 text-sm font-medium rounded-full border bg-primary-50 text-primary-700 border-primary-200 dark:bg-primary-900 dark:text-primary-300 dark:border-primary-700 whitespace-nowrap shadow-xs";
