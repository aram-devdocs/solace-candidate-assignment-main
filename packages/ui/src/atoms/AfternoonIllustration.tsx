...
/**
 * Afternoon time illustration SVG component.
 * Displays a sun at its peak with radiant rays.
 * Used in the Greeting component for afternoon time periods.
 *
 * @example
 * ```tsx
 ...
 * ```
 */
export const AfternoonIllustration: React.FC = () => (
  <svg
