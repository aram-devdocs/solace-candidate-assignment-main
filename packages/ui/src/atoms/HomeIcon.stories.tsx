  ...
  render: () => (
    <div className="flex items-end gap-8">
      <div className="text-center">
        <HomeIcon width={24} height={24} active={false} />
        <p className="text-secondary-600 mt-2 text-xs">24x24</p>
      </div>
      <div className="text-center">
        <HomeIcon width={32} height={31} active={false} />
        <p className="text-secondary-600 mt-2 text-xs">32x31</p>
      </div>
      <div className="text-center">
        <HomeIcon width={48} height={48} active={false} />
        <p className="text-secondary-600 mt-2 text-xs">48x48</p>
      </div>
      <div className="text-center">
        <HomeIcon width={64} height={64} active={false} />
